...
<head>
    ...
    <link rel="shortcut icon" href="img\senaverde.ico" type="image/x-icon">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <h2 style="cursor:pointer;" name="hand" class="inactive underlineHover">
                <a class="a" href="{{route('login')}}"> Iniciar sesion</a></h2>
            <h2 class="active" class="inactive underlineHover"><strong>Restrarse</strong></h2>
            <br/>
            <br/>
            ...
            <div class="fadeIn first">
                <img src="img\senaverde.png" id="icon" alt="User Icon" class="img" />
            </div>
            <br/>
            <!-- Login Form -->
            <form name="loginform">
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Nombre">
                <input type="text" id="login" class="fadeIn second" name="login" placeholder="Apellido">
                ...
                <input type="text" id="password" class="fadeIn third" name="login" placeholder="No Documento">
                <input type="email" id="password" class="fadeIn third" name="login" placeholder="Correo electronico">
               ...
               <div class="terms">
                ...
                <label for="terms"><a href="#">Acepto condiciones generales</a></label>
               </div>
               <!--End-->
                <br/>
                <a href="../templatemo_573_eduwell/index.html" style="cursor:pointer;" name="hand" type="submit" class="fadeIn fourth" value="Registrarse" disabled>Registrarse</a>
